...
function redirectAfterLogin(role, navigate) {
  ...
  switch (role) {
    ...
    case ROLES.SUPER_ADMIN:
      ...
      // JWT stays in localStorage + httpOnly cookie from /api/auth/login.

      // Staff portal restores session via cookie — never pass token in the URL.

      localStorage.removeItem('token')

      window.location.href = `${ADMIN_URL}${staffPortalPath(role)}`
